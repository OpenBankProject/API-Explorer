...
import org.eclipse.jetty.server.{Connector, HttpConfiguration, HttpConnectionFactory, SecureRequestCustomizer, ServerConnector, SslConnectionFactory}
...
object RunMtlsWebApp extends App {
  ...
  val connectors: Array[Connector] = {
    ...
    connector.setPort(Helper.getPropsAsIntValue("dev.port", 8082))
