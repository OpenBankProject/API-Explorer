...
*/
  ...
  def showResources = {
    ...
    val otherVersionUrls: List[(String, String)] = otherVersionsSupported.map(i => (i.replace("v1", "Berlin Group V1").replace("v2.0", "UK Open Banking V2.0"), s"${CurrentReq.value.uri}?version=${i}&list-all-banks=${listAllBanks}"))
